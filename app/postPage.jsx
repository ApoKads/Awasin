      ...
      {dummyPosts.map((post) => (
        <View key={post.id} className="bg-white rounded-2xl shadow mb-6 overflow-hidden">
          <View className="relative">
            ...
            {post.trending && (
              <Text className="absolute top-2 left-2 bg-black text-white text-xs px-2 py-1 rounded">
                #1 Trending
              </Text>
            )}
          ...
          <View className="px-4 py-3">
            ...
            <View className="flex-row items-center mb-1">
              <Image source={require('../assets/icons/vectorart-location.png')} className="w-4 h-4 mr-1" />
