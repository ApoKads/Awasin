    ...
    <Layout>
      ...
      <View className="flex-1 justify-start items-center p-6 pt-0 gap-4 ">
        ...
        <View className="w-full h-[50%] bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 justify-center items-center">
          ...
          <Text className="mt-2 text-gray-500 text-center px-4">Posisikan KTP Anda dalam frame</Text>
        </View>
        ...
        <View className="mt-6 flex gap-4 w-full items-center">
            ...
            <Text className="text-white  font-medium font-poppins ">Scan KTP</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={handleNext} className="w-[80%] bg-[#102E4A] px-8 py-3 rounded-xl flex items-center">
